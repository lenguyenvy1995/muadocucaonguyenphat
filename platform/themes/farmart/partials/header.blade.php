        ...
        <div @class([
            ...
            <div class="container-xxxl">
                <div class="header-wrapper">
                    ...
                    <div class="header-items header__right d-none d-md-flex">
...
@endif -->
                        @if (is_plugin_active('ecommerce'))
                            <form class="form--quick-search d-flex"
...
<div class="menu--product-categories">
                                    ...
                                    <div class="menu__content" style="border:0px !important;padding-top:0 !important">
